CLASS zzcl_fi_008 DEFINITION
  ...
  PRIVATE SECTION.
    ...
    CONSTANTS : xlsx_sheet_name TYPE string VALUE 'Sheet0',
                BEGIN OF api_params,
                  api_param_field_choose TYPE string VALUE 'choose',
                  api_param_value_choose TYPE string VALUE 'end_of_day',
                  api_param_field_from   TYPE string VALUE 'from',
                  api_param_field_to     TYPE string VALUE 'to',
                END OF api_params.
...
CLASS ZZCL_FI_008 IMPLEMENTATION.
...
*          ls_parameter-low.
  ...
  METHOD get_ratefile.
    ...
    request->set_uri_path( '/er-eeri-daily' ).

    request->set_form_field(
        i_name = zzcl_fi_008=>api_params-api_param_field_choose
        i_value = zzcl_fi_008=>api_params-api_param_value_choose
    ).
    ...
    request->set_form_field(
        i_name = zzcl_fi_008=>api_params-api_param_field_from
    ...
    request->set_form_field(
        i_name = zzcl_fi_008=>api_params-api_param_field_to
...
*    DATA(current_date) = cl_abap_context_info=>get_system_date(  ).
    ...
    DATA current_date TYPE datum.
    current_date = '20241201'.
